...
//            self.windowService.animateWindowSize(title: "main2", size: NSSize(width: 400, height: 400))
//            self.windowService.animateWindowPosition(title: "main2", point: NSPoint(x: 400, y: 400))
            
            self.windowService.animateFrame(title: "main2", rect: NSRect(
                x: 400, y: 400, width: 400, height: 400
            ))
       })
        
//        DispatchQueue.main.asyncAfter(deadline: .now() + 5.0, execute: {
//            self.windowService.animateWindowSize(title: "main2", size: NSSize(width: 200, height: 200))
//            self.windowService.animateWindowPosition(title: "main2", point: NSPoint(x: 200, y: 200))
//       })
